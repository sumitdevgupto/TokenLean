...
PROVIDER_MODELS = {
    ...
    "anthropic":{"model": "claude-3-5-haiku-20241022",   "litellm": "anthropic/claude-3-5-haiku-20241022",
                 "key_env": "ANTHROPIC_API_KEY","routes": ["claude-3-5-sonnet-20241022"]},
    "gemini":   {"model": "gemini-1.5-flash",            "litellm": "gemini/gemini-1.5-flash",
                 "key_env": "GEMINI_API_KEY",   "routes": ["gemini-1.5-pro"]},
    ...
    "xai":      {"model": "xai/grok-2-latest",           "litellm": "xai/grok-2-latest",
                 "key_env": "XAI_API_KEY",      "routes": ["xai/grok-3-mini"]},
